...
st.set_page_config(page_title='Ankush Singal', page_icon=":rainbow:")
    ...
    try:
        ...
        table1 = go.Figure (data=[go.Table (header=dict (
            ...
            cells=dict (values=[dates, maxtemp, mintemp, rain, cloud, humd],
                        line_color='black', fill_color=['paleturquoise', ['palegreen', '#fdbe72'] * 7], font_size=14,
                        height=32
                        ))])
